...
## Exercise 1
Create a vector 100 random integers in a column called "x", then filter out odd integers.  Hint:  you can use either `sample` or `runif` with `floor` to generate integers.  Print out the first 20 numbers.
